...
#ifndef _LIDAR_PERCEPTION_ROS_MATRIX_H_
#define _LIDAR_PERCEPTION_ROS_MATRIX_H_
...
#include "../../../src/common/utils/matrix.cpp"
//#define export /*export*/
#endif


#endif /* !defined(_LIDAR_PERCEPTION_ROS_MATRIX_H_) */
